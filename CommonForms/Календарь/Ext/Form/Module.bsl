...
Процедура ПриОткрытии(Отказ)
	Если ЗначениеЗаполнено(ТекущийПользователь) Тогда
		...
		ИначеЕсли НЕ ЗначениеЗаполнено(Календарь) Или Юзеры.ПервыйЗапуск(ТекущийПользователь) Тогда
			Сообщить(Пользователь + ", добро пожаловать в Негосударственный центр тестирования");
		КонецЕсли;
